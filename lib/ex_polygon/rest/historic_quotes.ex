defmodule ExPolygon.Rest.HistoricQuotes do
  @type history :: ExPolygon.History.t()
  @type api_key :: ExPolygon.Rest.HTTPClient.api_key()
  @type shared_error_reasons :: ExPolygon.Rest.HTTPClient.shared_error_reasons()

  @path "/v2/ticks/stocks/nbbo/:symbol/:date"
  ...
  def parse_response(%{"results" => results} = data) do
    results =
      results
      |> Enum.map(
        &Mapail.map_to_struct(&1, ExPolygon.StocksV2NBBO, transformations: [:snake_case])
      )
